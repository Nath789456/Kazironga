...
textFont('Georgia');
    fill("white");
    text("Distance Covered: " + score,width/2+100,height-30);
    text("Hunters killed: "+ hunterScore,width/2+100,height-50);
    drawSprites();
}
...
function spawnRhinos() {
    ...
    rhino.y = Math.round(random(200,300));
...
function spawnhunters() {
  ...
  if (frameCount % 170 === 0) {
    ...
    hunter.y = Math.round(random(200,300));
